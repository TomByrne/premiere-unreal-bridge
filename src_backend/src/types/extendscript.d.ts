...
interface FunctionConstructor {
   ...
   * @param args The list of formal arguments, separated by commas. The formal arguments can also be supplied one by one; in this case, the last argument to the Function constructor is considered to be the function body.
   * @param body The body of the function to create.
   */
  new (args: string, body: string): Function
  (args: string, body: string): Function
}
...
interface Function {
   ...
   * @param thisObj The object to be used as this.
   * @param args The first agument to the function. Add as many as needed.
   */
...
interface Folder {
   ...
   */
  getFiles(mask?: string | ((f:File | Folder) => boolean)): Array<File | Folder>
